...
.
âââ data/
â   âââ .fits files (Planck 100, 143, 217 GHz, Releases 1â3)
âââ src/
â   âââ Python scripts for image processing and statistical analysis
âââ docs/
â   âââ PDF documentation (Neutrinotime, CMB Dynamics papers)
âââ cielnofft.txt
    âââ CIEL/0 Theory of Everything framework implementation
```
...
- **Automated Source Detection:** Implements DAOStarFinder to flag objects exceeding 5Ď threshold
...
## đ Analysis Parameters

| Parameter | Value | Source |
|-----------|-------|--------|
| Semi-major axis | 430 AU | Lipa (2025) |
| Eccentricity | 0.78 | TNO Perturbation Model |
| Inclination | 27Â° | Puppis-Sector Calculation |
| Detection Sigma | > 5.0 | Point Source Threshold |

## đ Scientific Background

The scripts utilize the **LPEG Model** (Lipa-Penrose-Ebrahimi-Greene), which proposes that the cosmological constant (Î) is dynamic and can be influenced by local informational coherence. The search for the PBH represents a critical test of this theoretical framework.
